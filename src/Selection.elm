...
getSelectedText text selection =
    let
      ...
      startIndex = Pos.caretPosToIndex text normalizedSelection.start
      endIndex = Pos.caretPosToIndex text normalizedSelection.end
    in
...
normalizeSelection selection =
    if isReversed selection
      then { start = selection.end, end = selection.start }
      else selection
    ...
    case selection of
      ...
      Just sel ->
        let
          ...
          startIndex = Pos.caretPosToIndex text correctedSel.start
